-- outgoing trips per region (polygons), per dow and hour
...
WITH all_regions_dow_hour AS (
	...
	GROUP BY regions.region_id, dows.dow, hours.hour, oprdh.count  -- oprdh.count because that's singular already
)
SELECT
	region_id,
